...
app.get('/api/getproduct/:titlename',(req,res)=>{
    ...
    const getProductdata= new Promise((resolve,reject)=>{
            const sqlcommand=`SELECT * FROM products WHERE title LIKE "%${title_name}%" LIMIT 100`
...
app.get('/api/getcategory/:category',(req,res)=>{
    ...
    const getProductdata=new Promise((resolve,reject)=>{
        const sqlcommand=`SELECT * FROM products INNER JOIN categories ON products.category_id=categories.id WHERE category_name LIKE"%${category_name}%" OR title LIKE"%${category_name}%" ORDER BY RAND() LIMIT 100;`
...
app.get('/api/filters',(req,res)=>{
    ...
    const getFilteredData=new Promise((resolve,reject)=>{
        let sqlcommand;
        sqlcommand=`SELECT * FROM products WHERE title LIKE '%${title_name}%' AND price>=${min_price} AND price<${max_price} AND stars>${reviews} ORDER BY price ${sortby} limit 100;`
